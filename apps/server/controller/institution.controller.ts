...
import type { CreateInstitutionBody, UpdateInstitutionBody } from "../utils/type";
...
class InstitutionController {
    async createInstitution(req: Request, res: Response) {
        try {
            ...
            return res
                .status(200)
                .json(apiResponse(200, "institution created successfully", createdInstitution));
        } catch (error: any) {
            console.log(error);
    ...
    async updateInstitution(req: Request, res: Response) {
        try {
            ...
            return res
                .status(200)
                .json(
                    apiResponse(200, "institution updated successfully", updatedInstitution)
                );
        } catch (error: any) {
            console.log(error);
            return res.status(200).json(apiResponse(200, error.message, null));
    ...
    async getAllInstitutions(req: Request, res: Response) {
        try {
            ...
            return res
                .status(200)
                .json(apiResponse(200, "institutions fetched successfully", institutions));
        } catch (error: any) {
            console.log(error);
            return res.status(200).json(apiResponse(200, error.message, null));
        }
